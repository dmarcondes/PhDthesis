...
#' @details
#'
#' @param sample A data frame with the sample data. Should have collumns named x and y representing the input and output strings, and collumns variation and date containing the daily variation anda date for simulation.
#' @param predict A list of functions which, given an input string, returns a predicted output.
#' @param names A vector containing the names of the models which generated th predict functions.
#'
#' @return A list containing the sample data frame with new collumns for prdiction and simulation, the error of each model, a plot with the simularion and the data used in the plot.
